<template>
  <div class="mini_indicator mini_indicator6">
    <div class="progress_bar2">
      <div class="cursor"
           v-bind:style="{ transform: 'rotate(' + RASCVD *3.6 + 'deg)' }"></div>
      <div class="text_indicatition">
      <p class="big">{{RASCVD}}%</p>
      <p>10 years</p>
      </div>
    </div>
  </div>
   ...
   props: ['RASCVD'],
    ...
    methods:{
       start(){
           ...
           var cursor = document.querySelector('.sm .mini_indicator6 .progress_bar2 .cursor');
